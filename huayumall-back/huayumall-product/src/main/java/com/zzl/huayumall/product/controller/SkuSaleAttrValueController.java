...
public class SkuSaleAttrValueController {
    ...
    /**
     * 查询sku对应的销售属性的name和Value
     * @param skuId
     * @return
     */
    @GetMapping("/getSkuAttrBySkuId/{skuId}")
    public List<String> getSkuAttrBySkuId(@PathVariable("skuId") Long skuId){
        return skuSaleAttrValueService.getSkuAttrBySkuId(skuId);
    }
